...
def total_enrollment(school):
    total_number_of_students = 0
    total_annual_tuition_fees = 0
    for name, students, fees in school:
        total_number_of_students += students
        total_annual_tuition_fees += students * fees
    return total_number_of_students, total_annual_tuition_fees
